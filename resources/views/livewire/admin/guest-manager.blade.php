<div>
    <x-slot name="header">
        <div class="flex h-16 flex-shrink-0 items-center justify-between border-b border-gray-200 bg-white px-4 sm:px-6 lg:h-20 lg:px-8">
    ...
    <main class="min-w-0 flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
        ...
        <div class="mb-6 grid grid-cols-2 gap-3 lg:mb-8 lg:grid-cols-3 lg:gap-6">
            ...
            <div class="card rounded-2xl border border-gray-100 bg-white p-4 shadow-sm sm:p-5 lg:p-6">
                <div class="mb-2 flex items-start justify-between sm:mb-4">
                    ...
                    <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-green-50 text-green-600 sm:h-10 sm:w-10">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="col-span-2 card rounded-2xl border border-gray-100 bg-white p-4 shadow-sm sm:p-5 lg:col-span-1 lg:p-6">
                <div class="mb-2 flex items-start justify-between sm:mb-4">
                    <div>
                    ...
                    <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-50 text-blue-600 sm:h-10 sm:w-10">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
            <!-- Table Header -->
            <div class="flex flex-col items-start justify-between gap-3 border-b border-gray-100 p-4 sm:p-5 md:flex-row md:items-center lg:p-6">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <span class="shrink-0 text-xs text-gray-400">#{{ $guests->firstItem() + $index }}</span>
                                </div>
                                <div class="mt-3 grid grid-cols-2 gap-x-3 gap-y-2 border-t border-gray-100 pt-3 text-xs">
                                    <div>
                                        <p class="text-gray-400">Phone</p>
                                        <p class="mt-0.5 truncate font-medium text-gray-700">{{ $guest->phone ?? '—' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-400">Joined</p>
                                        <p class="mt-0.5 font-medium text-gray-700">{{ $guest->created_at->format('d M Y') }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-400">Bookings</p>
                                        <span class="mt-0.5 badge-{{ $guest->bookings_count > 0 ? 'primary' : 'warning' }}">
            ...
            <div class="hidden overflow-x-auto md:block">
                <table class="w-full min-w-[760px] text-left text-sm whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse ($guests as $index => $guest)
                            <tr wire:key="guest-desktop-{{ $guest->id }}" class="transition-colors hover:bg-gray-50">
