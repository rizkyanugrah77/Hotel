 <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
     <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
         ...
         <div>
             <div class="flex items-center gap-3 mb-6">
                 ...
                 <div>
                     ...
                     <span class="block text-[10px] uppercase tracking-[3px] text-red-600">Resort</span>
                 </div>
             </div>
         ...
         <div>
             ...
             <ul class="space-y-3">
                 <li><a href="/" class="text-red-600 hover:text-accent transition-colors text-sm">Home</a>
                 </li>
                 <li><a href="/pages/rooms.html" class="text-red-600 hover:text-accent transition-colors text-sm">Our
                         Rooms</a></li>
                 <li><a href="/pages/booking.html" class="text-red-600 hover:text-accent transition-colors text-sm">Book
                         a Stay</a></li>
                 <li><a href="#facilities"
                         class="text-red-600 hover:text-accent transition-colors text-sm">Facilities</a></li>
                 <li><a href="#gallery" class="text-red-600 hover:text-accent transition-colors text-sm">Gallery</a>
                 </li>
                 <li><a href="#testimonials"
                         class="text-red-600 hover:text-accent transition-colors text-sm">Reviews</a></li>
             </ul>
         </div>
         ...
         <div>
             ...
             <ul class="space-y-4">
                 <li class="flex items-start gap-3 text-sm text-red-600/60">
         ...
         <div>
             ...
             <p class=" text-sm text-red-600 mb-4">Subscribe for exclusive offers and Samosir travel tips.</p>
             <form class="space-y-3" aria-label="Newsletter subscription">
                 <input type="email" placeholder="Your email address"
                     class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-2xl placeholder:text-red-600/40 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all text-sm" />
     ...
     <div class="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
         <p class="text-red-600 text-sm">© 2026 Sitio Tio Resort. All rights reserved.</p>
         <div class="flex gap-6 text-sm text-red-600">
