...
<nav id="navbar" x-data="{ scrolled: false }" @scroll.window="scrolled = window.scrollY > 80"
    :class="scrolled ? 'shadow-lg bg-red-600/90 backdrop-blur-md' : 'bg-trasparent backdrop-blur-md'"
    ...
    <div class=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden lg:flex items-center gap-1">
                ...
                @auth
                    <a href="{{ url('/dashboard') }}" wire:navigate class="btn-accent text-sm !px-5 !py-2.5">
