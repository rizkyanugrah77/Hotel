                       ...
                       @foreach ($payments as $payment)
                           <tr class="hover:bg-gray-50/50 transition-colors">
                               <td class="py-3.5 px-6">
                                   <span
                                       class="font-mono text-xs font-medium text-primary bg-primary/5 px-2 py-1 rounded-lg">{{ $payment->booking->booking_code }}</span>
                               </td>
                               <td class="py-3.5 px-6">
                               ...
                               <td class="py-3.5 px-6 font-medium text-foreground">
                                   {{ $payment->booking->room->name ?? '-' }}</td>
                               <td class="py-3.5 px-6 text-gray-500">
                                   {{ $payment->booking->check_in->format('d M') }} —
                                   {{ $payment->booking->check_out->format('d M Y') }}</td>
